...
export const nav = `<a class="skip" href="#main">Skip to content</a><header class="nav wrap"><a class="wordmark" href="/">${image("icon", "", "", true, 40, 40)}<span>OTTER DAY</span></a><nav aria-label="Main navigation"><a href="/#learn">Game overview</a><a href="/guide/">Guide</a><a href="/faq/">FAQ</a></nav><a class="nav-cta" href="/#download">Get the app <span aria-hidden="true">↗</span></a></header>`;
