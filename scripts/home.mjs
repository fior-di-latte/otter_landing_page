...
const reviews = [
  ...
  ["“I came for the otters. I stayed for the calendar trick.”", "Sam · player"],
  [
...
export const home = `
<div class="wrap"><details class="award-banner" id="award"><summary><span class="award-mark" aria-hidden="true"><img src="/assets/award-laurel.svg" width="60" height="60" alt=""></span><span><strong>SHIPATON 2025 WINNER</strong><span>1st place · Best Vibes</span></span><span class="award-more">The story <b aria-hidden="true">↗</b></span></summary><div class="award-story"><figure>${image("times-square-v2", "AI recreation of the Otter Day billboard at One Times Square, with the New Year’s ball and clock above", "", false, 1536, 1024)}<figcaption>Times Square, reimagined with AI from the developer’s original photograph.</figcaption></figure><div><span class="eyebrow">A LITTLE GAME. A BIG MOMENT.</span><h2>From a date trick<br>to Times Square.</h2><p>Otter Day took first place in the Best Vibes category at RevenueCat’s Shipaton 2025, celebrating creative use of AI tools.</p><a class="text-link" href="https://www.revenuecat.com/blog/company/shipaton-2025-winners/#best-vibes-award">The official winners, on RevenueCat ↗</a><a class="text-link" href="https://felixplagge.dev/#/about/otter">The developer’s thoughts on the win ↗</a></div></div></details></div>
